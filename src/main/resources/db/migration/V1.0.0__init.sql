...
(
    ...
    DATA_RULE_ID       INT COMMENT '数据规则ID',
    CREATE_TIME        DATETIME COMMENT '创建时间' DEFAULT NOW()
) ENGINE = INNODB
  CHARSET = UTF8;
DROP TABLE IF EXISTS Authority_Data_Rule_Group;
CREATE TABLE Authority_Data_Rule_Group
(
    ID                 INT PRIMARY KEY AUTO_INCREMENT COMMENT '',
  ...
  CHARSET = UTF8;
DROP TABLE IF EXISTS Role_Authority_Data_Rule_Group_Relation;
CREATE TABLE Role_Authority_Data_Rule_Group_Relation
(
    ID                         INT PRIMARY KEY AUTO_INCREMENT COMMENT '',
...
(
    CODE        INT PRIMARY KEY AUTO_INCREMENT COMMENT '',
    LABEL       VARCHAR(16) COMMENT '',
    CREATE_TIME DATETIME COMMENT '创建时间' DEFAULT NOW()
) ENGINE = INNODB
  CHARSET = UTF8;
...
(
    ...
    VALUE       VARCHAR(16),
    CREATE_TIME DATETIME COMMENT '创建时间' DEFAULT NOW(),
    CONSTRAINT PRIMARY KEY DICTIONARY_PRIMARY_KEY (TYPE, CODE)
) ENGINE = INNODB
  CHARSET = UTF8;
